          ...
          {(onClose) => (
            <div>
              <div className="w-full aspect-square relative">
                <Image src={previewImage} alt="image-preview" fill className="object-cover" loading="lazy" />
              </div>
            </div>
          )}
        </ModalContent>
        ...
        <Card className="p-4">
          <div className="flex gap-2">
            <div>
              {uploadedImage ? (
                <div
                  className="relative w-52 h-52 rounded-md overflow-hidden cursor-pointer"
                  onClick={() => {
                ...
                >
                  ...
                  <Image src={uploadedImage} fill alt="new-image" className="object-cover" />
                </div>
              ) : (
        ...
        <Card className="p-4">
          <div className="grid grid-cols-6 gap-4">
            {photos.map(({ id, path }, index) => (
              ...
              >
                <div className={classNames(id == hoverImage ? 'absolute z-20 top-1 right-1 flex gap-1' : 'hidded')}>
                ...
                <Image fill src={path} alt="Image" className="max-w-40 object-cover" />
              </div>
            ))}
          </div>
        </Card>
